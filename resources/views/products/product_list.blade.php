                                        ...
                                        <div class="card-header border-0">
                                            <div class="row g-4">
                                                <div class="col-sm-auto">
                                                    <div>
                                                        <a href="{{url('/products/form')}}" class="btn btn-primary" id="addproduct-btn"><i class="ri-add-line align-bottom me-1"></i> Add Product</a>
                                                    </div>
                                                </div>
                                                <div class="col-sm">
                                            ...
                                            @foreach ($products as $key=>$product)
                                                <tr>
                                                    ...
                                                    <td class="d-flex gap-2 text-end">
                                                        ...
                                                        <div class="edit">
                                                            <a href="{{ route('products.form-update', ['id' => $product->id]) }}" class="btn btn-sm btn-primary edit-item-btn">Edit</a>
                                                        </div>
                                                        <div class="remove">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                                                            ...
                                                            <button type="button" class="btn w-sm btn-primary" onclick="event.preventDefault(); document.getElementById('delete-form-{{ $product->id }}').submit();">Yes, Delete It!</button>
                                                        </div>

                                                        <form id="delete-form-{{ $product->id }}" action="{{ route('products.delete', ['id' => $product->id]) }}" method="POST" style="display: none;">
                                                            @csrf
                                                            @method('DELETE')
                                                        </form>
                                                    </div>
